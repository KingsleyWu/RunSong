 ...
 * class name : RunSong
 * author : Kingsley
 * created date : on 2017/7/8 19:16
 * file change date : on 2017/7/8 19:16
 * version: 1.0
 */
...
public class FileUtil {
    ...
    private static String getAppDir() {
        return Environment.getExternalStorageDirectory() + "/RunSong";
    }
    ...
    static String getRelativeMusicDir() {
        String dir = "RunSong/Music/";
        return mkdirs(dir);
    }
